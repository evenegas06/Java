...
public class Registro extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String nombre, paterno, materno,direccion,telefono, noCuenta,nip;
        String fecha;
        String cuenta="";
 
        nombre=jTextField1.getText();
        paterno=jTextField2.getText();
        materno=jTextField3.getText();
        direccion=jTextField4.getText();
        telefono=jTextField5.getText();
        nip=jPasswordField1.getText();
        fecha=""+jSpinner1.getValue().toString()+"/"+(jMonthChooser1.getMonth()+1)+"/"+jYearChooser1.getYear();
        
       
        for (int i = 0; i < 7; i++) {
            cuenta=cuenta+new Random().nextInt(10);
        }
        JOptionPane.showMessageDialog(this, "Tu numero de cuenta es: "+cuenta);
        
        String accion=nombre+":"+paterno+":"+materno+":"+fecha+":"+direccion+":"+telefono+":"+cuenta+":"+nip;
        Cliente cliente = new Cliente(1,accion);
        cliente.start();
